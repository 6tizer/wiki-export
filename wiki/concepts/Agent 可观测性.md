...
- [摘要：这个小哥读完Anthropic关于智能体AI的博客后，我梳理出一套心智模型，用来理解并拆解智能体AI架构的设计逻辑。](summaries/摘要：这个小哥读完Anthropic关于智能体AI的博客后，我梳理出一套心智模型，用来理解并拆解智能体AI架构的设计逻辑。.md)（[原文](https://x.com/berryxia/status/2050001371307646977)）
