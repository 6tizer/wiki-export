...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/Tizer/747d27deec3b4ee8b935a3bdabfb21df
...
- [摘要：How top AI labs are building RL agents in 2026 (using Karpathy's system prompt learning idea)](summaries/摘要：How top AI labs are building RL agents in 2026 (using Karpathy's system prompt learning idea).md)（[原文](https://x.com/_avichawla/status/2049037299334472015)）｜RULER 将 LLM-as-judge 应用于 RL 训练的奖励评分
