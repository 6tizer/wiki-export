...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/1f1f7c44d8a5488bb27df53303274696
notion_id: 1f1f7c44-d8a5-488b-b27d-f53303274696
---

## 定义

**Simplicity First** 是一条 AI 编程原则，强调用最少、最直接的代码完成目标，避免过度设计、过早抽象和没有被请求的扩展。
