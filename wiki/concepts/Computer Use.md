...
- [摘要：Holo3：用十分之一的成本，打败 GPT-5.4 的 Computer Use 模型](summaries/摘要：Holo3：用十分之一的成本，打败 GPT-5.4 的 Computer Use 模型.md)（X书签文章，[原文](https://x.com/hcompany_ai/status/2039021096649805937)）
