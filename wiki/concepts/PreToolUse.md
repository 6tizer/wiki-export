...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/Tizer/68dd85595090488f9ca611f51a2d4ce4
...
- [摘要：Claude Code Hooks：用 settings.json 把 AI 编程助手从「偶尔听话」升级成「永不出错的工程队友」](summaries/摘要：Claude Code Hooks：用 settings.json 把 AI 编程助手从「偶尔听话」升级成「永不出错的工程队友」.md)（X书签文章，[原文](https://x.com/AYi_AInotes/status/2040238450373435857)，来源条目：Claude Code Hooks：用 settings.json 把 AI 编程助手从「偶尔听话」升级成「永不出错的工程队友」）
