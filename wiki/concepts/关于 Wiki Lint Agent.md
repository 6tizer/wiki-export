...
notion_url: https://www.notion.so/Tizer/5ee3bca30de04d6bb10016ba75368049
...
- **对比**：[关于 Gap Agent](concepts/关于 Gap Agent.md) 是「外审」（Wiki vs 外部世界），Lint Agent 是「内审」（Wiki 内部质量）

## 关联概念

- Wiki Fixer — 接收 Lint 报告并执行修复，完成后追加修复记录

- [关于 Gap Agent](concepts/关于 Gap Agent.md) — 互补关系：内审 vs 外审
