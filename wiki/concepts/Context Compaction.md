...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/Tizer/51fe93af771146d5b0ce8629be812fa2
...
- [摘要：Why memory isn't a plugin (it's the harness)](summaries/摘要：Why memory isn't a plugin (it's the harness).md)｜X书签｜2026/04/03｜主链接：[X 原文](https://x.com/sarahwooders/status/2040121230473457921)｜源页面：记忆不是插件，它是 Harness 本身：Letta 对 Agent 架构的重新定义
