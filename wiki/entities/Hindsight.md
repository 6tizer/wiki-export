...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/Tizer/04db46f336254f7087d13c2bb6990c99
notion_id: 04db46f3-3625-4f70-87d1-3c2bb6990c99
---

## 定义

Hindsight 是一个面向 Agent 的仿生记忆系统，把长期记忆拆成世界事实、经历记录与心智模型三类结构化存储。

## 关键要点

- 不把记忆仅仅当作向量检索，而是强调可反思、可提炼的多层记忆架构

- 通过 retain、recall、reflect 等操作支持记忆写入、检索与反思

- 在 LongMemEval 这类长期记忆基准上表现突出，代表了记忆系统从 RAG 向认知架构演进的方向

## 来源引用

- [原文链接](https://x.com/GitTrend0x/status/2040238756306067650)｜《GitHub Agent 军团屠榜实录：五个值得关注的 AI 开源项目》｜源文章：GitHub Agent 军团屠榜实录：五个值得关注的 AI 开源项目
