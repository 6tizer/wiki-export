...
- OpenViking：字节跳动用「文件系统范式」重构 Agent 记忆，终结扁平 RAG 时代
...
- 《一周暴涨 8.4k Star：GitHub Coding AI 开源项目周榜 Top 20 深度解析》— X书签，2026-03-16：将 OpenViking 视为 Agent 上下文数据库与文件系统范式代表
