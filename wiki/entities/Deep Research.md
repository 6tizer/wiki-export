...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/Tizer/0f2920d47d3c421aa2cbdde82d0e1da2
notion_id: 0f2920d4-7d3c-421a-a2cb-dde82d0e1da2
---

## 定义

Deep Research 是一类基于 AI 驱动的迭代搜索和推理来自动完成深度研究的方法和工具。Deep Research Web UI 是其代表性的开源实现，以树状结构可视化研究过程。

## 核心要点

- 多轮迭代搜索：通过多步骤搜索和推理逐步深入挖掘主题

- 端到端强化学习：使模型自主规划研究路径并动态调整策略

- 树状可视化：以图谱形式展示搜索内容和推理逻辑

- 多语言跨域：支持中英等多语言检索

- 多模态处理：解析文本、图像、表格等数据格式
...
- [摘要：Deep Research Web UI 开源深度研究助手](summaries/摘要：Deep Research Web UI 开源深度研究助手.md)
  ...
  - GitHub: [https://github.com/AnotiaWang/deep-research-web-ui](https://github.com/AnotiaWang/deep-research-web-ui)
...
- [摘要：22年的提示词技巧过时了！刚刚，吴恩达新课来了](summaries/摘要：22年的提示词技巧过时了！刚刚，吴恩达新课来了.md)（[原文](https://mp.weixin.qq.com/s?__biz=MzIyNjM2MzQyNg%3D%3D&mid=2247722427&idx=1&sn=55776d0460899f38803067362f1b2c06&chksm=e97f6bf70d561fd2d6990eea3dc1a7edf6af22ef286c69fd14f9cfd3ae1ec61f2042a9f04e77#rd)）
