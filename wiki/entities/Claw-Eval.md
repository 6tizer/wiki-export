...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/Tizer/b2b220796f454253a9c6024b2b52d700
notion_id: b2b22079-6f45-4253-a9c6-024b2b52d700
---

## 定义

Claw-Eval 是一个面向真实世界多步 Agent 任务的评测基准，用来观察模型在规划、工具调用、上下文保持与任务闭环方面的综合表现。

## 关键要点

- 它关注的不只是最终答案，而是模型在复杂流程中的持续推进能力

- 这类评测更能体现智能体在真实业务环境中的可用性与稳定性
