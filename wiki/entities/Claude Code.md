...
- 《The Agency：给你的 AI 编程工具配齐 144 个专属打工人》（@AYi_AInotes，X书签）— 补充 Claude Code 作为角色型 Agent 配置宿主的典型用法

- 《GEO-SEO Claude Code Skill：用 AI Agent 给网站做「AI 搜索引擎优化」》（GitHubDaily，X书签）— 补充 Claude Code 从编程助手扩展到 GEO/SEO 审计工作流的执行宿主角色
