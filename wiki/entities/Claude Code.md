...
source_tags: ''
source_article_url: ''
notion_url: https://www.notion.so/e2d64655509249e0bfb2002d206b2359
...
- 摘要：Claude Code 国内跑通指南：用阿里百炼 API，几十块钱进入 AI Agent 实战
...
- 摘要：134k Star 的宝藏仓库：AI 编程工具的 System Prompt 全被扒出来了

- 摘要：wshobson/agents：用 72 个插件把 Claude Code 变成 AI 开发部队

- 摘要：The Agency：给你的 AI 编程工具配齐 144 个专属打工人（@AYi_AInotes，X书签）— 补充 Claude Code 作为角色型 Agent 配置宿主的典型用法

- 摘要：GEO-SEO Claude Code Skill：用 AI Agent 给网站做「AI 搜索引擎优化」（GitHubDaily，X书签）— 补充 Claude Code 从编程助手扩展到 GEO/SEO 审计工作流的执行宿主角色

- 《手把手教你低成本用上 Claude Code：VPS + 住宅 IP + 订阅全流程》｜X书签文章｜原文链接：[https://x.com/aehyok/status/2031982094914896184](https://x.com/aehyok/status/2031982094914896184)
...
- 《wshobson/agents：用 72 个插件把 Claude Code 变成 AI 开发部队》（GitHub_Daily，2026-03-08）— 展示 Claude Code 如何通过插件、技能包和编排器扩展成多角色开发体系

- 《用 Claude Code 搭一套 BTC 合约交易信号系统，每小时推送到 Telegram》（zeroxmin，X书签）— 展示 Claude Code 作为一次性代码生成器，把分析流程固化为稳定脚本

- 《LangChain CEO：编程 Agent 正在重塑工程、产品与设计团队的协作方式》（Harrison Chase，X书签）— 将 Claude Code 放在编程 Agent 改变组织分工的语境中讨论

- 《Context Hub：吴恩达开源的 Coding Agent「文档新鲜度」解决方案》（AndrewYNg，X书签）— 体现 Claude Code 与运行时文档补充工具的协同方式
...
- 《Moss Trade Bot Factory：用自然语言创建你的 AI 加密交易员，$10k 模拟盘跑出 $2.4M 利润》｜X书签文章｜原文链接：[https://x.com/zeroxmin/status/2034607947171717158](https://x.com/zeroxmin/status/2034607947171717158)
