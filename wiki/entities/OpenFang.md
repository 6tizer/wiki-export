...
- 《OpenClaw 生态七件套：那些大项目之外值得关注的小众开源神器》（@_0xKenny (Kenny.eth)，X书签，2026-03）— 补充其作为 Agent OS 内核路线和高安全隔离方案的定位。

- 《OpenClaw 生态七件套：那些大项目之外值得关注的小众开源神器》— X书签，2026-03：将 OpenFang 视为从框架走向 Agent OS 的代表路线
